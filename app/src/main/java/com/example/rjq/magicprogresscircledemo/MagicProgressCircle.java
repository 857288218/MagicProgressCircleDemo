package com.example.rjq.magicprogresscircledemo;
...
public class MagicProgressCircle extends View {
    ...
    private boolean isFootOverHead, showThinRing;
    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        do {
            ...
            try {
                ...
                startColor = typedArray.getColor(R.styleable.MagicProgressCircle_mpc_start_color, Color.parseColor("#ff684e"));
                endColor = typedArray.getColor(R.styleable.MagicProgressCircle_mpc_end_color, Color.parseColor("#ff684e"));
                defaultColor = typedArray.getColor(R.styleable.MagicProgressCircle_mpc_default_color, Color.parseColor("#00ffffff"));
                thinRingColor = typedArray.getColor(R.styleable.MagicProgressCircle_mpc_thin_ring_color, Color.parseColor("#00ffffff"));
                isFootOverHead = typedArray.getBoolean(R.styleable.MagicProgressCircle_mpc_foot_over_head, false);
                showThinRing = typedArray.getBoolean(R.styleable.MagicProgressCircle_mpc_show_thin_ring, false);
            } finally {
                if (typedArray != null) {
                    typedArray.recycle();
                }
        ...
        if (showThinRing) {
            ...
            bgColorPaint.setStyle(Paint.Style.STROKE);
            bgColorPaint.setColor(thinRingColor);
            bgColorPaint.setStrokeWidth(strokeWidth / 2);
        }
    ...
    private Paint bgColorPaint; //填充的背景细线
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (showThinRing) {
            canvas.drawCircle(cx, cy, radius, bgColorPaint);
        }
